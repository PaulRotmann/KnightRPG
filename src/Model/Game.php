...
class Game {
	...
	public function getEnemyTypes() {
		return [
				'Goblin' => ['hp' => [20, 30], 'damage' => [5, 10], 'exp' => [15, 25], 'gold' => [5, 15]],
				'Orc' => ['hp' => [40, 60], 'damage' => [10, 18], 'exp' => [25, 40], 'gold' => [10, 25]],
				'Troll' => ['hp' => [80, 120], 'damage' => [18, 30], 'exp' => [40, 70], 'gold' => [20, 50]],
				'Drache' => ['hp' => [150, 200], 'damage' => [30, 50], 'exp' => [80, 120], 'gold' => [50, 100]]
		];
	}
